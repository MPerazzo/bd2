...
ALTER TABLE "BDII_TEAM2"."HOTEL_STATEMENT" STORAGE (NEXT 10240);

ALTER TABLE "BDII_TEAM2"."PAYMENT_ORDER" STORAGE (NEXT 10240);

ALTER TABLE "BDII_TEAM2"."SUPPLIER" STORAGE(NEXT 10240);
