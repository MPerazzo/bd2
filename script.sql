...
ALTER TABLE "BDII_TEAM2"."HOTEL_STATEMENT" PCTFREE 10 PCTUSED 40 PCTINCREASE 50; 

ALTER TABLE "BDII_TEAM2"."HOTEL_STATEMENT" STORAGE (NEXT 10240 PCTINCREASE 50);

ALTER TABLE "BDII_TEAM2"."PAYMENT_ORDER" PCTFREE 10 PCTUSED 40 PCTINCREASE 50; 

ALTER TABLE "BDII_TEAM2"."PAYMENT_ORDER" STORAGE (NEXT 10240 PCTINCREASE 50);

ALTER TABLE "BDII_TEAM2"."SUPPLIER" PCTFREE 10 PCTUSED 40 PCTINCREASE 50; 
