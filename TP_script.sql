...
## MODIFICACIÓN DE ÍNDICES NO UNIQUE A UNIQUE
...
CREATE UNIQUE INDEX "BDII_TEAM2"."HOTEL_STATEMENT_PK" ON "BDII_TEAM2"."HOTEL_STATEMENT" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 10240 NEXT 55296 MINEXTENTS 1 MAXEXTENTS 121
  PCTINCREASE 50 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "TEAM2_INDEXES";
...
CREATE UNIQUE INDEX "BDII_TEAM2"."PAYMENT_ORDER_PK" ON "BDII_TEAM2"."PAYMENT_ORDER" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 10240 NEXT 83968 MINEXTENTS 1 MAXEXTENTS 121
  PCTINCREASE 50 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "TEAM2_INDEXES";

CREATE UNIQUE INDEX "BDII_TEAM2"."SUPPLIER_PK" ON "BDII_TEAM2"."SUPPLIER" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
